      ...
      {backgroundPalettes.map((palette) => {
        ...
        return (
          <button
            ...
            className={cn(
              'relative grid h-7 w-7 place-items-center rounded-full border transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background',
              isSelected
          ...
          >
            {isSelected ? (
              <span className='grid h-4 w-4 place-items-center rounded-full bg-background/75 text-foreground shadow-sm backdrop-blur-sm'>
